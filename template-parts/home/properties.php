...
?>
<a class="button button--secondary section-link" href="<?php echo esc_url( home_url( '/properties/' ) ); ?>"><?php esc_html_e( 'View All Properties', 'estatein' ); ?></a><div class="home-slider" data-home-slider><div class="property-grid" data-home-track>
<?php
